...
public class IntraDayAMOLimitPrice {

	public static void main(String[] args) throws InterruptedException 
	{
		System.setProperty("Webdriver.chrome.driver", "C:\\Users\\Pocketful\\git\\StockGo");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='MuiInputBase-input MuiOutlinedInput-input css-1x5jdmq' and starts-with(@id,':r7:')]"))).sendKeys("6");
				...
				//Click on AMO
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class='MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary  col-xl-2 text-capitalize css-zytga1' and starts-with(@id,'simple-tab-3')]"))).click();
		
				//Increase the Quantity ( Units )
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-3']/div/div/div[1]/div[1]/div[1]/div[2]/img"))).click();
				
				//Select Limit Price CheckBox
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div[4]/div[3]/div/div[6]/div/div/div[2]/div[1]/input[@id='allSelect']"))).click();
				
				//Select Trigger Price CheckBox
				/*wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div[4]/div[3]/div/div[6]/div/div/div[2]/div[2]/input[@id='allSelect']"))).click();
				*/
				
				//Enter the Price
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-3']/div/div/div[1]/div[2]/input"))).clear();

				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-3']/div/div/div[1]/div[2]/input"))).sendKeys("12");
				
				
				//Enter the Triger Price
				/*wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-3']/div/div/div[1]/div[3]/input"))).clear();

				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-3']/div/div/div[1]/div[3]/input"))).sendKeys("12");
				*/
