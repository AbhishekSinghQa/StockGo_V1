...
public class LongTerm_AMO_LimitPrice {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		// Buy Stock
				...
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-1']/div/div/div[1]/div[1]/div[1]/div[2]/img"))).click();
				
				
				//Select Limit Price CheckBox
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div[4]/div[3]/div/div[4]/div/div/div[2]/div[1]/input[@id='allSelect']"))).click();
				
				//Select Trigger Price CheckBox
				/*wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div[4]/div[3]/div/div[4]/div/div/div[2]/div[2]/input[@id='allSelect']"))).click();
				*/
				
				//Enter the Price
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-1']/div/div/div[1]/div[2]/input"))).clear();
				...
				/*wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-1']/div/div/div[1]/div[3]/input"))).clear();

				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-1']/div/div/div[1]/div[3]/input"))).sendKeys("12");
				*/
